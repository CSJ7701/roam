...
Digital signal processing provides an alternative to this however, using what is known as an /Analog to Digital Converter/. The output from the A/D Converter is a digital signal that can be fed to a digital signal processor.
