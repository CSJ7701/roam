...
#+begin_src python :results verbatim :session Kaggle-DL-Hotel
  ...
  features_num=[
      "lead_time", "arrival_date_week_number", "arrival_data_day_of_month", "stays_in_weekend_nights", "stays_in_week_nights", "adults", "children", "babies", "is_repeated_guest", "previous_cancellations", "previous_bookings_not_cancelled", "required_car_parking_spaces", "total_of_special_requests", "adr"]

  features_cat=[
      "hotel", "arrival_date_month", "meal", "market_segment", "distribution_channel", "reserver_room_type", "deposit_type", "customer_type"]
